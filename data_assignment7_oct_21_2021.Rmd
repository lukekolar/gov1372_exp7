...
**ANSWER:** *It seems that the two main outcome variables for Reny and Newman (2021) are* `group_favorability_the_police` *and* `day_running`*. The former tells us how respondents feel about the police, and the latter gives us a relative timeframe through which to investigate this - before and after the protests.*
